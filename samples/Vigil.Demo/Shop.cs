...
/// <summary>
/// Endpoints volontairement "lourds" pour voir le rendu dans Vigil : nombreux paramètres d'URL,
...
internal static class Shop
{
    public static void MapShop(this WebApplication app)
    {
        ...
        // Mise à jour d'un client : gros objet imbriqué, mot de passe (masqué par Vigil), validation détaillée.
