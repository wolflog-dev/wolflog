...
/// <summary>
/// Configuration du client Wolflog. Se lit automatiquement depuis la section "Wolflog" de la configuration :
/// <code>
/// "Wolflog": { "Endpoint": "https://wolflog.mondomaine.fr", "ApiKey": "..." }
/// </code>
/// </summary>
public sealed class WolflogOptions
{
    ...
    /// <summary>Adresse du serveur Wolflog, ex: http://wolflog:5080. Obligatoire.</summary>
    public string? Endpoint { get; set; }

    /// <summary>Clé API d'ingestion (commande 'wolflog credentials' sur le serveur).</summary>
    ...
    /// <summary>Envoi des logs ILogger (et Serilog via Wolflog.Client.Serilog).</summary>
    ...
    /// <summary>Niveau minimum envoyé à Wolflog. null = règles "Logging:LogLevel" habituelles.</summary>
    ...
    /// <summary>Dossier du tampon disque (serveur injoignable, crashs). Par défaut : dossier temporaire/wolflog/&lt;service&gt;.</summary>
