...
internal static class VigilRuntime
{
...
internal sealed class VigilLifecycleService(
    IServiceProvider services,
    VigilTransport transport,
    ILoggerFactory loggers,
    CrashReporter? crashes = null) : IHostedService
{
    private readonly ILogger _log = loggers.CreateLogger("Vigil");
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        VigilRuntime.RaiseStarted(services);
