...
/// <summary>Santé de Wolflog lui-même : disque, écriture, réception, notifications, sauvegardes.</summary>
public sealed class HealthService(StorageHost storage, IOptions<WolflogServerOptions> options, AlertChannelStore channels, BackupState backups)
{
    public HealthReport Check()
    {
        ...
        checks.Add(backups.LastBackupAt is { } last
            ...
            : new HealthCheck("backup", "Sauvegarde", "ok", "Aucune sauvegarde réalisée depuis cette interface ou la commande wolflog backup"));
