...
/// <summary>
/// Supervision côté navigateur (RUM) : script /wolflog-rum.js et réception /v1/rum.
...
public static class RumEndpoints
{
    ...
    {
        using var s = typeof(RumEndpoints).Assembly.GetManifestResourceStream("wolflog-rum.js");
        if (s is null) return "/* wolflog-rum.js absent de cette version */"u8.ToArray();
    ...
    {
        public void MapWolflogRum()
        {
            app.MapGet("/wolflog-rum.js", (HttpContext ctx) =>
            {
    ...
    public static (ExportLogsServiceRequest, ExportTraceServiceRequest, ExportMetricsServiceRequest) Convert(RumBatch b, string? origin)
    {
        ...
        var scopeLogs = new ScopeLogs { Scope = new InstrumentationScope { Name = "Wolflog.Rum" } };
        var scopeSpans = new ScopeSpans { Scope = new InstrumentationScope { Name = "Wolflog.Rum" } };
        var scopeMetrics = new ScopeMetrics { Scope = new InstrumentationScope { Name = "Wolflog.Rum" } };
