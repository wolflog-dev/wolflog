...
public sealed class DashboardStore
{
    ...
    public DashboardStore(IOptions<WolflogServerOptions> options, IHostEnvironment env)
    {
    ...
    [
        ...
        new Dashboard
        {
            ...
            Description = "Web Vitals, chargement des pages, erreurs JavaScript et appels réseau vus depuis le navigateur (script wolflog-rum.js).",
            Panels =
            [
