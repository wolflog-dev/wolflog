...
public sealed class SignalStore<TRow> : ISignalStore, IAsyncDisposable
{
    ...
    private readonly WolflogServerOptions.StorageOptions _options;
    ...
    public SignalStore(SignalSchema<TRow> schema, DuckDbEngine engine, string dataDirectory, WolflogServerOptions.StorageOptions options, ILogger log)
    {
        _schema = schema;
        _engine = engine;
        _options = options;
