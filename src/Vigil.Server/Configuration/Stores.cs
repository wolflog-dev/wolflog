...
namespace Vigil.Server.Configuration;
...
public sealed class ErrorStateStore(IOptions<VigilServerOptions> o, IHostEnvironment env)
...
public sealed class DeploymentStore : JsonCollection<Deployment>
{
    ...
    public DeploymentStore(IOptions<VigilServerOptions> o, IHostEnvironment env)
...
public sealed class SavedSearchStore(IOptions<VigilServerOptions> o, IHostEnvironment env)
